...
const phrases = [
    ...
    'After choosing an opponent, you have 30 seconds to draw a logo incorporating an element chosen by the other players. The other players select the best one. Take 1 component !',
